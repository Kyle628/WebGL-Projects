...
var VSHADER_SOURCE =
  ...
  '  vec4 halfway = light + (cam_position - a_Position);\n' +
  '  if (is_blue == 1) {\n' +
...
var FSHADER_SOURCE =
  ...
  '    vec3 diffuse_color = mycolor;\n' +
  '    vec3 diffuse_color2 = mycolor;\n' +
...
function drawObject(vertarr, pgons, scale_factor, rotation_angle, x_amt, y_amt, z_amt,
 ...
 // console.log(polynorms);
  ...
  for (var i = 0; i < triarr.length; i += 10 /*10 bcs polygon identifier*/) {
    ...
    //console.log("passing triangle", triarr[i+9]);
    //console.log("passing normal", [polynorms[triarr[i+9]][0], polynorms[triarr[i+9]][1], polynorms[triarr[i+9]][2]]);
